...
/** BxlMPosControllerDallasKeyPlugin */
public class BxlMPosControllerDallasKeyPlugin implements FlutterPlugin, MethodCallHandler{
    ...
    private MPosControllerDallasKey dallaskey = new MPosControllerDallasKey();
    ...
    public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
        final String METHOD_CHANNEL = "com.bixolon.mposcontroller/dallaskey";
        final String DATA_EVENT_CHANNEL = "com.bixolon.mposcontroller/dallaskey/data";
    ...
    public void selectInterface(@NonNull MethodCall call, @NonNull Result result) {
        ...
        try{
            result.success((int)dallaskey.selectInterface(interfaceType, address));
        }catch(Exception e){
            result.success(1000);
        }
    }
    ...
    public void selectCommandMode(@NonNull MethodCall call, @NonNull Result result) {
        ...
        try{
            result.success((int)dallaskey.selectCommandMode(mode));
        }catch(Exception e){
            result.success(1000);
        }
    }
    ...
    public void openService(@NonNull MethodCall call, @NonNull Result result) {
        ...
        try{
            int apiResult = (int)dallaskey.openService(id, timeout, context);
    ...
    public void closeService(@NonNull MethodCall call, @NonNull Result result) {
        Integer timeout = (Integer)getValue(call, "time_out", 3);
        try{
            result.success((int)dallaskey.closeService(timeout));
        }catch(Exception e){
            result.success(1000);
        }
    }
    ...
    public void isOpen(@NonNull MethodCall call, @NonNull Result result) {
        try{
            result.success(dallaskey.isOpen() ? 1 : 0);
        }catch(Exception e){
            result.success(0);
        }
    }
    ...
    public void getDeviceId(@NonNull MethodCall call, @NonNull Result result) {
        try{
            result.success((int)dallaskey.getDeviceId());
        }catch(Exception e){
            result.success(-1);
        }
    }
    ...
    public void directIO(@NonNull MethodCall call, @NonNull Result result) {
        ...
        try{
            ...
            result.success((int)dallaskey.directIO(byteArray));
        }catch(Exception e){
            result.success(1000);
        }
    }
    ...
    public void setReadMode(@NonNull MethodCall call, @NonNull Result result) {
        ...
        try{
            result.success((int)dallaskey.setReadMode(mode));
        }catch(Exception e){
            result.success(1000);
        }
    }
    ...
    public void setTransaction(@NonNull MethodCall call, @NonNull Result result) {
        ...
        try{
            result.success((int)dallaskey.setTransaction(transaction));
        }catch(Exception e){
            result.success(1000);
        }
    }
