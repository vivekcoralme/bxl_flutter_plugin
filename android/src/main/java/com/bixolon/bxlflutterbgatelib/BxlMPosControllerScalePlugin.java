...
import com.bixolon.mpos.MPosControllerScale;

/** BxlMPosControllerScalePlugin */
public class BxlMPosControllerScalePlugin implements FlutterPlugin, MethodCallHandler{
    ...
    private MPosControllerScale scale = new MPosControllerScale();
    ...
    public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
        final String METHOD_CHANNEL = "com.bixolon.mposcontroller/scale";
        final String DATA_EVENT_CHANNEL = "com.bixolon.mposcontroller/scale/data";
    ...
    public void selectInterface(@NonNull MethodCall call, @NonNull Result result) {
        ...
        try{
            result.success((int)scale.selectInterface(interfaceType, address));
        }catch(Exception e){
            result.success(1000);
        }
    }
    ...
    public void selectCommandMode(@NonNull MethodCall call, @NonNull Result result) {
        ...
        try{
            result.success((int)scale.selectCommandMode(mode));
        }catch(Exception e){
            result.success(1000);
        }
    }
    ...
    public void openService(@NonNull MethodCall call, @NonNull Result result) {
        ...
        try{
            int apiResult = (int)scale.openService(id, timeout, context);
    ...
    public void closeService(@NonNull MethodCall call, @NonNull Result result) {
        Integer timeout = (Integer)getValue(call, "time_out", 3);
        try{
            result.success((int)scale.closeService(timeout));
        }catch(Exception e){
            result.success(1000);
        }
    }
    ...
    public void isOpen(@NonNull MethodCall call, @NonNull Result result) {
        try{
            result.success(scale.isOpen() ? 1 : 0);
        }catch(Exception e){
            result.success(0);
        }
    }
    ...
    public void getDeviceId(@NonNull MethodCall call, @NonNull Result result) {
        try{
            result.success((int)scale.getDeviceId());
        }catch(Exception e){
            result.success(-1);
        }
    }
    ...
    public void directIO(@NonNull MethodCall call, @NonNull Result result) {
        ...
        try{
            ...
            result.success((int)scale.directIO(byteArray));
        }catch(Exception e){
            result.success(1000);
        }
    }
    ...
    public void setReadMode(@NonNull MethodCall call, @NonNull Result result) {
        ...
        try{
            result.success((int)scale.setReadMode(mode));
        }catch(Exception e){
            result.success(1000);
        }
    }
    ...
    public void setTransaction(@NonNull MethodCall call, @NonNull Result result) {
        ...
        try{
            result.success((int)scale.setTransaction(transaction));
        }catch(Exception e){
            result.success(1000);
        }
    }
