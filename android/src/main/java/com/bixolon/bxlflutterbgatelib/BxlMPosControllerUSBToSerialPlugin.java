...
import com.bixolon.mpos.MPosControllerUSBSerial;

/** BxlMPosControllerUSBSerialPlugin */
public class BxlMPosControllerUSBToSerialPlugin implements FlutterPlugin, MethodCallHandler{
    ...
    private MPosControllerUSBSerial usbserial = new MPosControllerUSBSerial();
    ...
    public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
        final String METHOD_CHANNEL = "com.bixolon.mposcontroller/usbtoserial";
        final String DATA_EVENT_CHANNEL = "com.bixolon.mposcontroller/usbtoserial/data";
    ...
    public void selectInterface(@NonNull MethodCall call, @NonNull Result result) {
        ...
        try{
            result.success((int)usbserial.selectInterface(interfaceType, address));
        }catch(Exception e){
            result.success(1000);
        }
    }
    ...
    public void selectCommandMode(@NonNull MethodCall call, @NonNull Result result) {
        ...
        try{
            result.success((int)usbserial.selectCommandMode(mode));
        }catch(Exception e){
            result.success(1000);
        }
    }
    ...
    public void openService(@NonNull MethodCall call, @NonNull Result result) {
        ...
        try{
            int apiResult = (int)usbserial.openService(id, timeout, context);
    ...
    public void closeService(@NonNull MethodCall call, @NonNull Result result) {
        Integer timeout = (Integer)getValue(call, "time_out", 3);
        try{
            result.success((int)usbserial.closeService(timeout));
        }catch(Exception e){
            result.success(1000);
        }
    }
    ...
    public void isOpen(@NonNull MethodCall call, @NonNull Result result) {
        try{
            result.success(usbserial.isOpen() ? 1 : 0);
        }catch(Exception e){
            result.success(0);
        }
    }
    ...
    public void getDeviceId(@NonNull MethodCall call, @NonNull Result result) {
        try{
            result.success((int)usbserial.getDeviceId());
        }catch(Exception e){
            result.success(-1);
        }
    }
    ...
    public void directIO(@NonNull MethodCall call, @NonNull Result result) {
        ...
        try{
            ...
            result.success((int)usbserial.directIO(byteArray));
        }catch(Exception e){
            result.success(1000);
        }
    }
    ...
    public void setReadMode(@NonNull MethodCall call, @NonNull Result result) {
        ...
        try{
            result.success((int)usbserial.setReadMode(mode));
        }catch(Exception e){
            result.success(1000);
        }
    }
    ...
    public void setTransaction(@NonNull MethodCall call, @NonNull Result result) {
        ...
        try{
            result.success((int)usbserial.setTransaction(transaction));
        }catch(Exception e){
            result.success(1000);
        }
    }
