...
/** BxlMPosControllerMSRPlugin */
public class BxlMPosControllerMSRPlugin implements FlutterPlugin, MethodCallHandler{
    ...
    private MPosControllerMSR msr = new MPosControllerMSR();
    ...
    public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
        final String METHOD_CHANNEL = "com.bixolon.mposcontroller/msr";
        final String DATA_EVENT_CHANNEL = "com.bixolon.mposcontroller/msr/data";
    ...
    public void selectInterface(@NonNull MethodCall call, @NonNull Result result) {
        ...
        try{
            result.success((int)msr.selectInterface(interfaceType, address));
        }catch(Exception e){
            result.success(1000);
        }
    }
    ...
    public void selectCommandMode(@NonNull MethodCall call, @NonNull Result result) {
        ...
        try{
            result.success((int)msr.selectCommandMode(mode));
        }catch(Exception e){
            result.success(1000);
        }
    }
    ...
    public void openService(@NonNull MethodCall call, @NonNull Result result) {
        ...
        try{
            int apiResult = (int)msr.openService(id, timeout, context);
    ...
    public void closeService(@NonNull MethodCall call, @NonNull Result result) {
        Integer timeout = (Integer)getValue(call, "time_out", 3);
        try{
            result.success((int)msr.closeService(timeout));
        }catch(Exception e){
            result.success(1000);
        }
    }
    ...
    public void getDeviceId(@NonNull MethodCall call, @NonNull Result result) {
        try{
            result.success((int)msr.getDeviceId());
        }catch(Exception e){
            result.success(-1);
        }
    }
    ...
    public void directIO(@NonNull MethodCall call, @NonNull Result result) {
        ...
        try{
            ...
            result.success((int)msr.directIO(byteArray));
        }catch(Exception e){
            result.success(1000);
        }
    }
    ...
    public void setReadMode(@NonNull MethodCall call, @NonNull Result result) {
        ...
        try{
            result.success((int)msr.setReadMode(mode));
        }catch(Exception e){
            result.success(1000);
        }
    }
    ...
    public void setTransaction(@NonNull MethodCall call, @NonNull Result result) {
        ...
        try{
            result.success((int)msr.setTransaction(transaction));
        }catch(Exception e){
            result.success(1000);
        }
    }
