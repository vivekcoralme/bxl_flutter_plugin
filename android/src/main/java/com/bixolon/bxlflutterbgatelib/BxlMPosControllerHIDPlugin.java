...
import com.bixolon.mpos.MPosControllerHID;

/** BxlMPosControllerHIDPlugin */
public class BxlMPosControllerHIDPlugin implements FlutterPlugin, MethodCallHandler{
    ...
    private MPosControllerHID hid = new MPosControllerHID();
    ...
    public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
        final String METHOD_CHANNEL = "com.bixolon.mposcontroller/hid";
        final String DATA_EVENT_CHANNEL = "com.bixolon.mposcontroller/hid/data";
    ...
    public void selectInterface(@NonNull MethodCall call, @NonNull Result result) {
        ...
        try{
            result.success((int)hid.selectInterface(interfaceType, address));
        }catch(Exception e){
            result.success(1000);
        }
    }
    ...
    public void selectCommandMode(@NonNull MethodCall call, @NonNull Result result) {
        ...
        try{
            result.success((int)hid.selectCommandMode(mode));
        }catch(Exception e){
            result.success(1000);
        }
    }
    ...
    public void openService(@NonNull MethodCall call, @NonNull Result result) {
        ...
        try{
            int apiResult = (int)hid.openService(id, timeout, context);
    ...
    public void closeService(@NonNull MethodCall call, @NonNull Result result) {
        Integer timeout = (Integer)getValue(call, "time_out", 3);
        try{
            result.success((int)hid.closeService(timeout));
        }catch(Exception e){
            result.success(1000);
        }
    }
    ...
    public void getDeviceId(@NonNull MethodCall call, @NonNull Result result) {
        try{
            result.success((int)hid.getDeviceId());
        }catch(Exception e){
            result.success(-1);
        }
    }
    ...
    public void directIO(@NonNull MethodCall call, @NonNull Result result) {
        ...
        try{
            ...
            result.success((int)hid.directIO(byteArray));
        }catch(Exception e){
            result.success(1000);
        }
    }
    ...
    public void setReadMode(@NonNull MethodCall call, @NonNull Result result) {
        ...
        try{
            result.success((int)hid.setReadMode(mode));
        }catch(Exception e){
            result.success(1000);
        }
    }
    ...
    public void setTransaction(@NonNull MethodCall call, @NonNull Result result) {
        ...
        try{
            result.success((int)hid.setTransaction(transaction));
        }catch(Exception e){
            result.success(1000);
        }
    }
